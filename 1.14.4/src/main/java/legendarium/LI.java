...
public class LI {
	...
	public static class RegistryEvents {
		...
		public static void onItemsRegistry(RegistryEvent.Register<Item> event) {
			armor_anarion_helmet = new LIItemArmor(LIMaterial.ANARION, EquipmentSlotType.HEAD);
			armor_anarion_chestplate = new LIItemArmor(LIMaterial.ANARION, EquipmentSlotType.CHEST);
			armor_anarion_legs = new LIItemArmor(LIMaterial.ANARION, EquipmentSlotType.LEGS);
			armor_anarion_boots = new LIItemArmor(LIMaterial.ANARION, EquipmentSlotType.FEET);

			armor_arpharazon_helmet = new LIItemArmor(LIMaterial.ARPHARAZON, EquipmentSlotType.HEAD);
			armor_arpharazon_chestplate = new LIItemArmor(LIMaterial.ARPHARAZON, EquipmentSlotType.CHEST);
			armor_arpharazon_legs = new LIItemArmor(LIMaterial.ARPHARAZON, EquipmentSlotType.LEGS);
			armor_arpharazon_boots = new LIItemArmor(LIMaterial.ARPHARAZON, EquipmentSlotType.FEET);

			armor_arvedui_helmet = new LIItemArmor(LIMaterial.ARVEDUI, EquipmentSlotType.HEAD);
			armor_arvedui_chestplate = new LIItemArmor(LIMaterial.ARVEDUI, EquipmentSlotType.CHEST);
			armor_arvedui_legs = new LIItemArmor(LIMaterial.ARVEDUI, EquipmentSlotType.LEGS);
			armor_arvedui_boots = new LIItemArmor(LIMaterial.ARVEDUI, EquipmentSlotType.FEET);

			armor_boromir_chestplate = new LIItemArmor(LIMaterial.BOROMIR, EquipmentSlotType.CHEST);
			armor_boromir_legs = new LIItemArmor(LIMaterial.BOROMIR, EquipmentSlotType.LEGS);
			armor_boromir_boots = new LIItemArmor(LIMaterial.BOROMIR, EquipmentSlotType.FEET);

			armor_elendil_helmet = new LIItemArmor(LIMaterial.ELENDIL, EquipmentSlotType.HEAD);
			armor_elendil_chestplate = new LIItemArmor(LIMaterial.ELENDIL, EquipmentSlotType.CHEST);
			armor_elendil_legs = new LIItemArmor(LIMaterial.ELENDIL, EquipmentSlotType.LEGS);
			armor_elendil_boots = new LIItemArmor(LIMaterial.ELENDIL, EquipmentSlotType.FEET);

			armor_elros_helmet = new LIItemArmor(LIMaterial.ELROS, EquipmentSlotType.HEAD);
			armor_elros_chestplate = new LIItemArmor(LIMaterial.ELROS, EquipmentSlotType.CHEST);
			armor_elros_legs = new LIItemArmor(LIMaterial.ELROS, EquipmentSlotType.LEGS);
			armor_elros_boots = new LIItemArmor(LIMaterial.ELROS, EquipmentSlotType.FEET);

			armor_feanor_helmet = new LIItemArmor(LIMaterial.FEANOR, EquipmentSlotType.HEAD);
			armor_feanor_chestplate = new LIItemArmor(LIMaterial.FEANOR, EquipmentSlotType.CHEST);
			armor_feanor_legs = new LIItemArmor(LIMaterial.FEANOR, EquipmentSlotType.LEGS);
			armor_feanor_boots = new LIItemArmor(LIMaterial.FEANOR, EquipmentSlotType.FEET);

			armor_gilgalad_helmet = new LIItemArmor(LIMaterial.GILGALAD, EquipmentSlotType.HEAD);
			armor_gilgalad_chestplate = new LIItemArmor(LIMaterial.GILGALAD, EquipmentSlotType.CHEST);
			armor_gilgalad_legs = new LIItemArmor(LIMaterial.GILGALAD, EquipmentSlotType.LEGS);
			armor_gilgalad_boots = new LIItemArmor(LIMaterial.GILGALAD, EquipmentSlotType.FEET);

			armor_gimli_helmet = new LIItemArmor(LIMaterial.GIMLI, EquipmentSlotType.HEAD);
			armor_gimli_chestplate = new LIItemArmor(LIMaterial.GIMLI, EquipmentSlotType.CHEST);
			armor_gimli_legs = new LIItemArmor(LIMaterial.GIMLI, EquipmentSlotType.LEGS);
			armor_gimli_boots = new LIItemArmor(LIMaterial.GIMLI, EquipmentSlotType.FEET);

			armor_isildur_helmet = new LIItemArmor(LIMaterial.ISILDUR, EquipmentSlotType.HEAD);
			armor_isildur_chestplate = new LIItemArmor(LIMaterial.ISILDUR, EquipmentSlotType.CHEST);
			armor_isildur_legs = new LIItemArmor(LIMaterial.ISILDUR, EquipmentSlotType.LEGS);
			armor_isildur_boots = new LIItemArmor(LIMaterial.ISILDUR, EquipmentSlotType.FEET);

			armor_jiindur_helmet = new LIItemArmor(LIMaterial.JIINDUR, EquipmentSlotType.HEAD);
			armor_jiindur_chestplate = new LIItemArmor(LIMaterial.JIINDUR, EquipmentSlotType.CHEST);
			armor_jiindur_legs = new LIItemArmor(LIMaterial.JIINDUR, EquipmentSlotType.LEGS);
			armor_jiindur_boots = new LIItemArmor(LIMaterial.JIINDUR, EquipmentSlotType.FEET);

			armor_khamul_helmet = new LIItemArmor(LIMaterial.KHAMUL, EquipmentSlotType.HEAD);
			armor_khamul_chestplate = new LIItemArmor(LIMaterial.KHAMUL, EquipmentSlotType.CHEST);
			armor_khamul_legs = new LIItemArmor(LIMaterial.KHAMUL, EquipmentSlotType.LEGS);
			armor_khamul_boots = new LIItemArmor(LIMaterial.KHAMUL, EquipmentSlotType.FEET);

			armor_khommurat_helmet = new LIItemArmor(LIMaterial.KHOMMURAT, EquipmentSlotType.HEAD);
			armor_khommurat_chestplate = new LIItemArmor(LIMaterial.KHOMMURAT, EquipmentSlotType.CHEST);
			armor_khommurat_legs = new LIItemArmor(LIMaterial.KHOMMURAT, EquipmentSlotType.LEGS);
			armor_khommurat_boots = new LIItemArmor(LIMaterial.KHOMMURAT, EquipmentSlotType.FEET);

			armor_morgomir_helmet = new LIItemArmor(LIMaterial.MORGOMIR, EquipmentSlotType.HEAD);
			armor_morgomir_chestplate = new LIItemArmor(LIMaterial.MORGOMIR, EquipmentSlotType.CHEST);
			armor_morgomir_legs = new LIItemArmor(LIMaterial.MORGOMIR, EquipmentSlotType.LEGS);
			armor_morgomir_boots = new LIItemArmor(LIMaterial.MORGOMIR, EquipmentSlotType.FEET);

			armor_theoden_helmet = new LIItemArmor(LIMaterial.THEODEN, EquipmentSlotType.HEAD);
			armor_theoden_chestplate = new LIItemArmor(LIMaterial.THEODEN, EquipmentSlotType.CHEST);
			armor_theoden_legs = new LIItemArmor(LIMaterial.THEODEN, EquipmentSlotType.LEGS);
			armor_theoden_boots = new LIItemArmor(LIMaterial.THEODEN, EquipmentSlotType.FEET);

			armor_turgon_helmet = new LIItemArmor(LIMaterial.TURGON, EquipmentSlotType.HEAD);
			armor_turgon_chestplate = new LIItemArmor(LIMaterial.TURGON, EquipmentSlotType.CHEST);
			armor_turgon_legs = new LIItemArmor(LIMaterial.TURGON, EquipmentSlotType.LEGS);
			armor_turgon_boots = new LIItemArmor(LIMaterial.TURGON, EquipmentSlotType.FEET);
