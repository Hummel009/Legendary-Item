...
public class LI {
	...
	public void onInit(FMLInitializationEvent event) {
		...
		armorArpharazonChestplate = new LIItemArmor(LIConfig.idArmorArpharazonChestplate - 256, LIMaterial.ARPHARAZON,
				1);
