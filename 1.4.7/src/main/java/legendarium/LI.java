...
public class LI {
	...
	public void onInit(FMLInitializationEvent event) {
		...
		armorAnarionLeggings = new LIItemArmor(LIConfig.idArmorAnarionLeggings - 256, LIMaterial.ANARION, 2);
		...
		armorArpharazonLeggings = new LIItemArmor(LIConfig.idArmorArpharazonLeggings - 256, LIMaterial.ARPHARAZON, 2);
		...
		armorArveduiLeggings = new LIItemArmor(LIConfig.idArmorArveduiLeggings - 256, LIMaterial.ARVEDUI, 2);
		...
		armorBoromirLeggings = new LIItemArmor(LIConfig.idArmorBoromirLeggings - 256, LIMaterial.BOROMIR, 2);
		...
		armorElendilLeggings = new LIItemArmor(LIConfig.idArmorElendilLeggings - 256, LIMaterial.ELENDIL, 2);
		...
		armorElrosLeggings = new LIItemArmor(LIConfig.idArmorElrosLeggings - 256, LIMaterial.ELROS, 2);
		...
		armorFeanorLeggings = new LIItemArmor(LIConfig.idArmorFeanorLeggings - 256, LIMaterial.FEANOR, 2);
		...
		armorGilgaladLeggings = new LIItemArmor(LIConfig.idArmorGilgaladLeggings - 256, LIMaterial.GILGALAD, 2);
		...
		armorGimliLeggings = new LIItemArmor(LIConfig.idArmorGimliLeggings - 256, LIMaterial.GIMLI, 2);
		...
		armorIsildurLeggings = new LIItemArmor(LIConfig.idArmorIsildurLeggings - 256, LIMaterial.ISILDUR, 2);
		...
		armorJiindurLeggings = new LIItemArmor(LIConfig.idArmorJiindurLeggings - 256, LIMaterial.JIINDUR, 2);
		...
		armorKhamulLeggings = new LIItemArmor(LIConfig.idArmorKhamulLeggings - 256, LIMaterial.KHAMUL, 2);
		...
		armorHoarmurathLeggings = new LIItemArmor(LIConfig.idArmorHoarmurathLeggings - 256, LIMaterial.HOARMURATH, 2);
		...
		armorMorgomirLeggings = new LIItemArmor(LIConfig.idArmorMorgomirLeggings - 256, LIMaterial.MORGOMIR, 2);
		...
		armorTheodenLeggings = new LIItemArmor(LIConfig.idArmorTheodenLeggings - 256, LIMaterial.THEODEN, 2);
		...
		armorTurgonLeggings = new LIItemArmor(LIConfig.idArmorTurgonLeggings - 256, LIMaterial.TURGON, 2);
		...
		armorAnarionBoots.setIconIndex(id++);
		armorAnarionChestplate.setIconIndex(id++);
		armorAnarionHelmet.setIconIndex(id++);
		armorAnarionLeggings.setIconIndex(id++);
		armorArpharazonBoots.setIconIndex(id++);
		armorArpharazonChestplate.setIconIndex(id++);
		armorArpharazonHelmet.setIconIndex(id++);
		armorArpharazonLeggings.setIconIndex(id++);
		armorArveduiBoots.setIconIndex(id++);
		armorArveduiChestplate.setIconIndex(id++);
		armorArveduiHelmet.setIconIndex(id++);
		armorArveduiLeggings.setIconIndex(id++);
		armorBoromirBoots.setIconIndex(id++);
		armorBoromirChestplate.setIconIndex(id++);
		armorBoromirLeggings.setIconIndex(id++);
		armorElendilBoots.setIconIndex(id++);
		armorElendilChestplate.setIconIndex(id++);
		armorElendilHelmet.setIconIndex(id++);
		armorElendilLeggings.setIconIndex(id++);
		armorElrosBoots.setIconIndex(id++);
		armorElrosChestplate.setIconIndex(id++);
		armorElrosHelmet.setIconIndex(id++);
		armorElrosLeggings.setIconIndex(id++);
		armorFeanorBoots.setIconIndex(id++);
		armorFeanorChestplate.setIconIndex(id++);
		armorFeanorHelmet.setIconIndex(id++);
		armorFeanorLeggings.setIconIndex(id++);
		armorGilgaladBoots.setIconIndex(id++);
		armorGilgaladChestplate.setIconIndex(id++);
		armorGilgaladHelmet.setIconIndex(id++);
		armorGilgaladLeggings.setIconIndex(id++);
		armorGimliBoots.setIconIndex(id++);
		armorGimliChestplate.setIconIndex(id++);
		armorGimliHelmet.setIconIndex(id++);
		armorGimliLeggings.setIconIndex(id++);
		armorIsildurBoots.setIconIndex(id++);
		armorIsildurChestplate.setIconIndex(id++);
		armorIsildurHelmet.setIconIndex(id++);
		armorIsildurLeggings.setIconIndex(id++);
		armorJiindurBoots.setIconIndex(id++);
		armorJiindurChestplate.setIconIndex(id++);
		armorJiindurHelmet.setIconIndex(id++);
		armorJiindurLeggings.setIconIndex(id++);
		armorKhamulBoots.setIconIndex(id++);
		armorKhamulChestplate.setIconIndex(id++);
		armorKhamulHelmet.setIconIndex(id++);
		armorKhamulLeggings.setIconIndex(id++);
		armorHoarmurathBoots.setIconIndex(id++);
		armorHoarmurathChestplate.setIconIndex(id++);
		armorHoarmurathHelmet.setIconIndex(id++);
		armorHoarmurathLeggings.setIconIndex(id++);
		armorMorgomirBoots.setIconIndex(id++);
		armorMorgomirChestplate.setIconIndex(id++);
		armorMorgomirHelmet.setIconIndex(id++);
		armorMorgomirLeggings.setIconIndex(id++);
		armorTheodenBoots.setIconIndex(id++);
		armorTheodenChestplate.setIconIndex(id++);
		armorTheodenHelmet.setIconIndex(id++);
		armorTheodenLeggings.setIconIndex(id++);
		armorTurgonBoots.setIconIndex(id++);
		armorTurgonChestplate.setIconIndex(id++);
		armorTurgonHelmet.setIconIndex(id++);
		armorTurgonLeggings.setIconIndex(id++);
