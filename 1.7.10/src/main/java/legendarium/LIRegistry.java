...
public class LIRegistry {
	...
	public static void preInit() {
		...
		LIRegistry.register(armor_anarion_helmet, "armor_anarion_helmet");
		LIRegistry.register(armor_anarion_chestplate, "armor_anarion_chestplate");
		LIRegistry.register(armor_anarion_legs, "armor_anarion_legs");
		LIRegistry.register(armor_anarion_boots, "armor_anarion_boots");
		LIRegistry.register(armor_arpharazon_helmet, "armor_arpharazon_helmet");
		LIRegistry.register(armor_arpharazon_chestplate, "armor_arpharazon_chestplate");
		LIRegistry.register(armor_arpharazon_legs, "armor_arpharazon_legs");
		LIRegistry.register(armor_arpharazon_boots, "armor_arpharazon_boots");
		LIRegistry.register(armor_arvedui_helmet, "armor_arvedui_helmet");
		LIRegistry.register(armor_arvedui_chestplate, "armor_arvedui_chestplate");
		LIRegistry.register(armor_arvedui_legs, "armor_arvedui_legs");
		LIRegistry.register(armor_arvedui_boots, "armor_arvedui_boots");
		LIRegistry.register(armor_boromir_chestplate, "armor_boromir_chestplate");
		LIRegistry.register(armor_boromir_legs, "armor_boromir_legs");
		LIRegistry.register(armor_boromir_boots, "armor_boromir_boots");
		LIRegistry.register(armor_elendil_helmet, "armor_elendil_helmet");
		LIRegistry.register(armor_elendil_chestplate, "armor_elendil_chestplate");
		LIRegistry.register(armor_elendil_legs, "armor_elendil_legs");
		LIRegistry.register(armor_elendil_boots, "armor_elendil_boots");
		LIRegistry.register(armor_elros_helmet, "armor_elros_helmet");
		LIRegistry.register(armor_elros_chestplate, "armor_elros_chestplate");
		LIRegistry.register(armor_elros_legs, "armor_elros_legs");
		LIRegistry.register(armor_elros_boots, "armor_elros_boots");
		LIRegistry.register(armor_feanor_helmet, "armor_feanor_helmet");
		LIRegistry.register(armor_feanor_chestplate, "armor_feanor_chestplate");
		LIRegistry.register(armor_feanor_legs, "armor_feanor_legs");
		LIRegistry.register(armor_feanor_boots, "armor_feanor_boots");
		LIRegistry.register(armor_gilgalad_helmet, "armor_gilgalad_helmet");
		LIRegistry.register(armor_gilgalad_chestplate, "armor_gilgalad_chestplate");
		LIRegistry.register(armor_gilgalad_legs, "armor_gilgalad_legs");
		LIRegistry.register(armor_gilgalad_boots, "armor_gilgalad_boots");
		LIRegistry.register(armor_gimli_helmet, "armor_gimli_helmet");
		LIRegistry.register(armor_gimli_chestplate, "armor_gimli_chestplate");
		LIRegistry.register(armor_gimli_legs, "armor_gimli_legs");
		LIRegistry.register(armor_gimli_boots, "armor_gimli_boots");
		LIRegistry.register(armor_isildur_helmet, "armor_isildur_helmet");
		LIRegistry.register(armor_isildur_chestplate, "armor_isildur_chestplate");
		LIRegistry.register(armor_isildur_legs, "armor_isildur_legs");
		LIRegistry.register(armor_isildur_boots, "armor_isildur_boots");
		LIRegistry.register(armor_jiindur_helmet, "armor_jiindur_helmet");
		LIRegistry.register(armor_jiindur_chestplate, "armor_jiindur_chestplate");
		LIRegistry.register(armor_jiindur_legs, "armor_jiindur_legs");
		LIRegistry.register(armor_jiindur_boots, "armor_jiindur_boots");
		LIRegistry.register(armor_khamul_helmet, "armor_khamul_helmet");
		LIRegistry.register(armor_khamul_chestplate, "armor_khamul_chestplate");
		LIRegistry.register(armor_khamul_legs, "armor_khamul_legs");
		LIRegistry.register(armor_khamul_boots, "armor_khamul_boots");
		LIRegistry.register(armor_khommurat_helmet, "armor_khommurat_helmet");
		LIRegistry.register(armor_khommurat_chestplate, "armor_khommurat_chestplate");
		LIRegistry.register(armor_khommurat_legs, "armor_khommurat_legs");
		LIRegistry.register(armor_khommurat_boots, "armor_khommurat_boots");
		LIRegistry.register(armor_morgomir_helmet, "armor_morgomir_helmet");
		LIRegistry.register(armor_morgomir_chestplate, "armor_morgomir_chestplate");
		LIRegistry.register(armor_morgomir_legs, "armor_morgomir_legs");
		LIRegistry.register(armor_morgomir_boots, "armor_morgomir_boots");
		LIRegistry.register(armor_theoden_helmet, "armor_theoden_helmet");
		LIRegistry.register(armor_theoden_chestplate, "armor_theoden_chestplate");
		LIRegistry.register(armor_theoden_legs, "armor_theoden_legs");
		LIRegistry.register(armor_theoden_boots, "armor_theoden_boots");
		LIRegistry.register(armor_turgon_helmet, "armor_turgon_helmet");
		LIRegistry.register(armor_turgon_chestplate, "armor_turgon_chestplate");
		LIRegistry.register(armor_turgon_legs, "armor_turgon_legs");
		LIRegistry.register(armor_turgon_boots, "armor_turgon_boots");
		LIRegistry.register(weapon_acharn, "weapon_acharn");
		LIRegistry.register(weapon_aeglos, "weapon_aeglos");
		LIRegistry.register(weapon_alatar, "weapon_alatar");
		LIRegistry.register(weapon_angrist, "weapon_angrist");
		LIRegistry.register(weapon_anguirel, "weapon_anguirel");
		LIRegistry.register(weapon_aranruth, "weapon_aranruth");
		LIRegistry.register(weapon_azog, "weapon_azog");
		LIRegistry.register(weapon_balin, "weapon_balin");
		LIRegistry.register(weapon_barazanthual, "weapon_barazanthual");
		LIRegistry.register(weapon_bolg, "weapon_bolg");
		LIRegistry.register(weapon_boromir, "weapon_boromir");
		LIRegistry.register(weapon_celeborn, "weapon_celeborn");
		LIRegistry.register(weapon_dagmor, "weapon_dagmor");
		LIRegistry.register(weapon_dain, "weapon_dain");
		LIRegistry.register(weapon_denethor, "weapon_denethor");
		LIRegistry.register(weapon_dori, "weapon_dori");
		LIRegistry.register(weapon_dramborleg, "weapon_dramborleg");
		LIRegistry.register(weapon_durin, "weapon_durin");
		LIRegistry.register(weapon_dwalin, "weapon_dwalin");
		LIRegistry.register(weapon_eothain, "weapon_eothain");
		LIRegistry.register(weapon_eowyn, "weapon_eowyn");
		LIRegistry.register(weapon_faramir, "weapon_faramir");
		LIRegistry.register(weapon_gamling, "weapon_gamling");
		LIRegistry.register(weapon_gimli, "weapon_gimli");
		LIRegistry.register(weapon_girion, "weapon_girion");
		LIRegistry.register(weapon_goblinking, "weapon_goblinking");
		LIRegistry.register(weapon_gorbag, "weapon_gorbag");
		LIRegistry.register(weapon_gothmog, "weapon_gothmog");
		LIRegistry.register(weapon_grima, "weapon_grima");
		LIRegistry.register(weapon_gurthang, "weapon_gurthang");
		LIRegistry.register(weapon_guthwine, "weapon_guthwine");
		LIRegistry.register(weapon_hadhafang, "weapon_hadhafang");
		LIRegistry.register(weapon_herugrim, "weapon_herugrim");
		LIRegistry.register(weapon_khamul, "weapon_khamul");
		LIRegistry.register(weapon_kili, "weapon_kili");
		LIRegistry.register(weapon_legolas, "weapon_legolas");
		LIRegistry.register(weapon_melkor, "weapon_melkor");
		LIRegistry.register(weapon_mouthofsauron, "weapon_mouthofsauron");
		LIRegistry.register(weapon_narcil, "weapon_narcil");
		LIRegistry.register(weapon_nazgul, "weapon_nazgul");
		LIRegistry.register(weapon_orcrist, "weapon_orcrist");
		LIRegistry.register(weapon_pallando, "weapon_pallando");
		LIRegistry.register(weapon_radagast, "weapon_radagast");
		LIRegistry.register(weapon_saruman, "weapon_saruman");
		LIRegistry.register(weapon_shagrat, "weapon_shagrat");
		LIRegistry.register(weapon_thorin, "weapon_thorin");
		LIRegistry.register(weapon_thorondun, "weapon_thorondun");
		LIRegistry.register(weapon_thrain, "weapon_thrain");
		LIRegistry.register(weapon_thranduil, "weapon_thranduil");
		LIRegistry.register(weapon_thror, "weapon_thror");
		LIRegistry.register(weapon_urfael, "weapon_urfael");
		LIRegistry.register(weapon_witchking, "weapon_witchking");
		LIRegistry.register(ranged_azkar, "ranged_azkar");
		LIRegistry.register(ranged_bard, "ranged_bard");
		LIRegistry.register(ranged_belthronding, "ranged_belthronding");
		LIRegistry.register(ranged_bregor, "ranged_bregor");
		LIRegistry.register(ranged_haldir, "ranged_haldir");
		LIRegistry.register(ranged_legolas, "ranged_legolas");
		LIRegistry.register(ranged_lurtz, "ranged_lurtz");
		LIRegistry.register(arkenstone, "arkenstone");
		LIRegistry.register(silmaril, "silmaril");
	}
