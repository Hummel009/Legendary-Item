...
* Актуальный проект, состоящий из 3 модулей (appForge, appFabric и appNeoForge). В этом случае папкой проекта является весь
  репозиторий целиком.
...
| 1.18.2 - 1.19.4  | 8.5    | ForgeGradle 6.X; FabricLoom            | 21.0.2     | 21.0.2      | 17.0.9        | 17     |
| 1.20.4 и новее   | 8.5    | ForgeGradle 6.X; FabricLoom; NeoGradle | 21.0.2     | 21.0.2      | 17.0.9        | 17     |
