...
* Актуальный проект, состоящий из 2 модулей (appForge и appFabric). В этом случае папкой проекта является весь
  репозиторий целиком.
* Архивный проект, состоящий из 13 модулей (1.3.2 - 1.7.10; 1.12.2 - 1.19.4). Важно: папки 1.8.9 - 1.11.2 модулями
  не являются, их придётся открывать отдельно. Об этом будет подробно написано ниже.
* Архивный проект, состоящий из 6 модулей (1.14.4 - 1.19.4).

| Версия Minecraft | Gradle | Плагин сборки               | Gradle JDK | Project JDK | Toolchain JDK | Syntax |
|------------------|--------|-----------------------------|------------|-------------|---------------|--------|
| 1.3.2 - 1.6.4    | 8.5    | Voldeloom                   | 21.0.2     | 21.0.2      | 11.0.21       | 6      |
| 1.7.10, 1.12.2   | 8.5    | RetroFuturaGradle           | 21.0.2     | 21.0.2      | 1.8.0_392     | 8      |
| 1.8.9 - 1.11.2*  | 2.14   | ForgeGradle 2.X             | 1.8.0_392  | 1.8.0_392   | 1.8.0_392     | 8      |
| 1.13.2 - 1.16.5  | 8.5    | ForgeGradle 6.X; FabricLoom | 21.0.2     | 21.0.2      | 1.8.0_392     | 8      |
| 1.17.1           | 8.5    | ForgeGradle 6.X; FabricLoom | 21.0.2     | 21.0.2      | 16.0.2        | 16     |
| 1.18.2 и новее   | 8.5    | ForgeGradle 6.X; FabricLoom | 21.0.2     | 21.0.2      | 17.0.9        | 17     |
