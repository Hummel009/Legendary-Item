...
import static legendarium.LIObfuscationHelper.*;
...
public class LI {
	...
	public static void register(Item item, String field) {
		...
		setCreativeTab(item, LICreativeTabs.TAB_ARTIFACTS);
	...
	public void onInit(FMLInitializationEvent event) {
		...
		setIconIndex(arkenstone, 0);
		setIconIndex(armorAnarionBoots, 1);
		setIconIndex(armorAnarionChestplate, 2);
		setIconIndex(armorAnarionHelmet, 3);
		setIconIndex(armorAnarionLegs, 4);
		setIconIndex(armorArpharazonBoots, 5);
		setIconIndex(armorArpharazonChestplate, 6);
		setIconIndex(armorArpharazonHelmet, 7);
		setIconIndex(armorArpharazonLegs, 8);
		setIconIndex(armorArveduiBoots, 9);
		setIconIndex(armorArveduiChestplate, 10);
		setIconIndex(armorArveduiHelmet, 11);
		setIconIndex(armorArveduiLegs, 12);
		setIconIndex(armorBoromirBoots, 13);
		setIconIndex(armorBoromirChestplate, 14);
		setIconIndex(armorBoromirLegs, 15);
		setIconIndex(armorElendilBoots, 16);
		setIconIndex(armorElendilChestplate, 17);
		setIconIndex(armorElendilHelmet, 18);
		setIconIndex(armorElendilLegs, 19);
		setIconIndex(armorElrosBoots, 20);
		setIconIndex(armorElrosChestplate, 21);
		setIconIndex(armorElrosHelmet, 22);
		setIconIndex(armorElrosLegs, 23);
		setIconIndex(armorFeanorBoots, 24);
		setIconIndex(armorFeanorChestplate, 25);
		setIconIndex(armorFeanorHelmet, 26);
		setIconIndex(armorFeanorLegs, 27);
		setIconIndex(armorGilgaladBoots, 28);
		setIconIndex(armorGilgaladChestplate, 29);
		setIconIndex(armorGilgaladHelmet, 30);
		setIconIndex(armorGilgaladLegs, 31);
		setIconIndex(armorGimliBoots, 32);
		setIconIndex(armorGimliChestplate, 33);
		setIconIndex(armorGimliHelmet, 34);
		setIconIndex(armorGimliLegs, 35);
		setIconIndex(armorIsildurBoots, 36);
		setIconIndex(armorIsildurChestplate, 37);
		setIconIndex(armorIsildurHelmet, 38);
		setIconIndex(armorIsildurLegs, 39);
		setIconIndex(armorJiindurBoots, 40);
		setIconIndex(armorJiindurChestplate, 41);
		setIconIndex(armorJiindurHelmet, 42);
		setIconIndex(armorJiindurLegs, 43);
		setIconIndex(armorKhamulBoots, 44);
		setIconIndex(armorKhamulChestplate, 45);
		setIconIndex(armorKhamulHelmet, 46);
		setIconIndex(armorKhamulLegs, 47);
		setIconIndex(armorKhommuratBoots, 48);
		setIconIndex(armorKhommuratChestplate, 49);
		setIconIndex(armorKhommuratHelmet, 50);
		setIconIndex(armorKhommuratLegs, 51);
		setIconIndex(armorMorgomirBoots, 52);
		setIconIndex(armorMorgomirChestplate, 53);
		setIconIndex(armorMorgomirHelmet, 54);
		setIconIndex(armorMorgomirLegs, 55);
		setIconIndex(armorTheodenBoots, 56);
		setIconIndex(armorTheodenChestplate, 57);
		setIconIndex(armorTheodenHelmet, 58);
		setIconIndex(armorTheodenLegs, 59);
		setIconIndex(armorTurgonBoots, 60);
		setIconIndex(armorTurgonChestplate, 61);
		setIconIndex(armorTurgonHelmet, 62);
		setIconIndex(armorTurgonLegs, 63);
		setIconIndex(silmaril, 64);
		setIconIndex(weaponAcharn, 65);
		setIconIndex(weaponAeglos, 66);
		setIconIndex(weaponAlatar, 67);
		setIconIndex(weaponAngrist, 68);
		setIconIndex(weaponAnguirel, 69);
		setIconIndex(weaponAranruth, 70);
		setIconIndex(weaponAzog, 71);
		setIconIndex(weaponBalin, 72);
		setIconIndex(weaponBarazanthual, 73);
		setIconIndex(weaponBolg, 74);
		setIconIndex(weaponBoromir, 75);
		setIconIndex(weaponCeleborn, 76);
		setIconIndex(weaponDagmor, 77);
		setIconIndex(weaponDain, 78);
		setIconIndex(weaponDenethor, 79);
		setIconIndex(weaponDori, 80);
		setIconIndex(weaponDramborleg, 81);
		setIconIndex(weaponDurin, 82);
		setIconIndex(weaponDwalin, 83);
		setIconIndex(weaponEothain, 84);
		setIconIndex(weaponEowyn, 85);
		setIconIndex(weaponFaramir, 86);
		setIconIndex(weaponGamling, 87);
		setIconIndex(weaponGimli, 88);
		setIconIndex(weaponGirion, 89);
		setIconIndex(weaponGoblinking, 90);
		setIconIndex(weaponGorbag, 91);
		setIconIndex(weaponGothmog, 92);
		setIconIndex(weaponGrima, 93);
		setIconIndex(weaponGurthang, 94);
		setIconIndex(weaponGuthwine, 95);
		setIconIndex(weaponHadhafang, 96);
		setIconIndex(weaponHerugrim, 97);
		setIconIndex(weaponKhamul, 98);
		setIconIndex(weaponKili, 99);
		setIconIndex(weaponLegolas, 100);
		setIconIndex(weaponMelkor, 101);
		setIconIndex(weaponMouthofsauron, 102);
		setIconIndex(weaponNarcil, 103);
		setIconIndex(weaponNazgul, 104);
		setIconIndex(weaponOrcrist, 105);
		setIconIndex(weaponPallando, 106);
		setIconIndex(weaponRadagast, 107);
		setIconIndex(weaponSaruman, 108);
		setIconIndex(weaponShagrat, 109);
		setIconIndex(weaponThorin, 110);
		setIconIndex(weaponThorondun, 111);
		setIconIndex(weaponThrain, 112);
		setIconIndex(weaponThranduil, 113);
		setIconIndex(weaponThror, 114);
		setIconIndex(weaponUrfael, 115);
		setIconIndex(weaponWitchking, 116);
